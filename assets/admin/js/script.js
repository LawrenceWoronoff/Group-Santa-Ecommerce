"use strict";
var base_url = 'http://localhost/group_santa';
var wieldy = {
    docBody: $('body'),
    customStyle: null,
...
function changeTheme($theme, $style, $themeStylesheet, $init) {
    ...
    $themeStylesheet.href = base_url + '/assets/admin/css/semidark-style-1.min.css';
    
    localStorage.setItem('dt-theme', 'semidark');
    localStorage.setItem('dt-style', 'style-1');
