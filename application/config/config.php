...
|
*/
$config['base_url'] = 'http://localhost/group_santa';
// $config['send_grid_api_key'] = "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";

$config['send_grid_api_key'] = "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";
...
$config['csrf_exclude_uris'] = array('user/do_add_cart', 'user/do_remove_cart', 'user/do_remove_from_view/(:any)', 'admin/do_reset_password');
